"""
Management command: cargar_san_andres_v7

Carga los 14 capítulos y preguntas del Perfil San Andrés / SAI V7
basado en el Diccionario oficial UARIV.

Diferencias clave vs Perfil Territorial V7:
  - Cap. A: sin campo "vereda" (islas usan barrio/sector)
  - Cap. A8: "Nombre del sector" en lugar de "Nombre de la vereda"
  - Cap. B: preguntas de identidad RAIZAL (pueblo nativo de SAIPSCA)
  - Cap. M: contexto insular (pesca artesanal, territorio marítimo)
  No tiene capítulos exclusivos NA, NP, O (propios de Buenaventura)

Uso:
    python manage.py cargar_san_andres_v7
    python manage.py cargar_san_andres_v7 --reset
"""
...
INSTRUMENTO_PK = "22222222-0003-0003-0003-000000000003"  # San Andrés / SAI V7
...
PREGUNTAS = {
    # ── A. IDENTIFICACIÓN ─────────────────────────────────────────────────────
    # SAI: A8 usa "sector" en lugar de "vereda" (San Andrés no tiene veredas)
    "A": [
        ...
        ("A8",  "SECTOR",       882,  "Nombre del sector",                                                      "TEXTO",          "HOGAR", False, 8,  False, "",               {"max_length": 150}),
        ("A9",  "Z8",           6,    "Dirección de la vivienda o nombre del predio",                           "TEXTO",          "HOGAR", False, 9,  False, "",               {"max_length": 300}),
        ...
        ("A17", "Z17",          1165, "Barrio o sector (correspondencia)",                                       "TEXTO",          "HOGAR", False, 17, False, "",               {"max_length": 200}),
        ("A18", "Z18",          1166, "Nombre del sector (correspondencia)",                                     "TEXTO",          "HOGAR", False, 18, False, "",               {"max_length": 150}),
    ...
    # ── J. ALIMENTACIÓN (nivel HOGAR) ─────────────────────────────────────────
    # SAI: incluye "pescado y mariscos" como ítem diferenciado por contexto insular
    "JA": [
    ...
    # ── M. USO Y DISFRUTE DEL TERRITORIO ─────────────────────────────────────
    # SAI: incluye actividades de pesca artesanal y uso del mar como territorio
    "M": [
        ("M1",  "AT1A",      1209, "¿Por cuáles de los siguientes motivos mantiene una relación con el territorio insular?", "LISTA_MULTIPLE", "HOGAR", True,  1, False, "", {}),
        ("M2",  "AT2",       900,  "¿A su hogar se le ha adjudicado materialmente terreno/lote/predio?",                     "BOOLEAN",        "HOGAR", True,  2, False, "", {}),
        ("M3",  "AT3",       901,  "¿Este terreno o predio es parte de un territorio colectivo?",                            "LISTA",          "HOGAR", False, 3, False, "", {}),
        ...
        ("M8",  "AT8A",      907,  "¿En el predio existen factores de riesgo?",                                              "LISTA_MULTIPLE", "HOGAR", False, 8, False, "", {}),
    ...
    "T": [],
    # ── B. DATOS BÁSICOS ──────────────────────────────────────────────────────
    # SAI: incluye preguntas de identidad RAIZAL (pueblo nativo del archipiélago)
    "B": [
        ...
        # SAI: identidad RAIZAL — pueblo nativo del archipiélago SAIPSCA
        ("B28", "A12",        290,  "¿A qué pueblo indígena o RAIZAL pertenece?",                                             "TEXTO",          "PERSONA", False, 27, False, "",                        {"max_length": 150}),
        ("B29", "A13",        291,  "¿A qué comunidad pertenece?",                                                            "TEXTO",          "PERSONA", False, 28, False, "",                        {"max_length": 150}),
        ("B30", "A13A",       868,  "¿A qué cabildo o consejo comunitario pertenece?",                                        "TEXTO",          "PERSONA", False, 29, False, "",                        {"max_length": 150}),
        ...
        ("B36", "A19",        296,  "¿Reconoce la autoridad del Resguardo o Consejo Comunitario?",                            "BOOLEAN",        "PERSONA", False, 35, False, "",                        {}),
        # SAI: idioma propio = Creole English (Islander Creole)
        ("B37", "A14",        292,  "¿Su comunidad o pueblo tiene un idioma propio? (Creole / lengua nativa)",                "BOOLEAN",        "PERSONA", False, 36, False, "",                        {}),
    ...
    "F": [
        ...
        ("F5", "G17",       873,  "¿Asiste a clases de idioma propio (Creole)?",                                              "BOOLEAN", "PERSONA", False, 5, False, "",                 {}),
    ...
    # ── J. FUERZA DE TRABAJO (nivel PERSONA) ──────────────────────────────────
    "JF": [
...
class Command(BaseCommand):
    help = "Carga los 14 capítulos y preguntas del Perfil San Andrés / SAI V7"
