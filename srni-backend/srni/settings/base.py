        ...
        'navigation': [
            {
                ...
                'items': [
                    ...
                    # Nota: OpcionRespuesta no está registrado como ModelAdmin
                    # propio (solo aparece como inline dentro de Pregunta), por
                    # lo que no tiene changelist y se omite del sidebar.
                    {'title': 'Reglas Skip-Logic',
