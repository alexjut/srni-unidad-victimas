...
| `oracle/puntos_atencion_oracle.json` | **nuevo** — 1.370 filas / **266 puntos** reales (pendiente 3a.11) |
...
**Tests: 134/134** en `apps/sincronizacion` (eran 105). Suite completa: **286 pasan**, con
los mismos 7 fallos preexistentes de `apps/formulario/tests/test_cargar_diccionario.py`
(verificados ajenos a este trabajo).
...
| # | Pendiente | Estado |
|---|---|---|
| 3a.11 | Reemplazar el placeholder de 41 puntos de atención de SICAV por los **266 reales** | 🟡 dato ya volcado, falta cargarlo |
